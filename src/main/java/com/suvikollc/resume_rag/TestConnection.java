...
public class TestConnection {
    ...
    public static void main(String[] args) {
        ...
        String connectionString = "DefaultEndpointsProtocol=https;AccountName=jobresume;AccountKey=x9MPjvjOnZKC7xO5pok96k+Q0buNr/gKsjv9jDDVw+SpryTf2qIKZWDEJ3r8d+Ofxdr0hgDg9n8X+AStWqkpKQ==;EndpointSuffix=core.windows.net";
